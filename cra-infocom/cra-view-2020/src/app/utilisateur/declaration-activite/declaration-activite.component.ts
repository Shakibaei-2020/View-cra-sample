...
export class DeclarationActiviteComponent implements OnInit {
  ...
  idRemplirProjetAstreinte1 = "idRemplirProjetAstreinte1"
  idRemplirProjetAstreinte3 = "idRemplirProjetAstreinte3"
  idRemplirProjetAstreinte2 = "idRemplirProjetAstreinte2"
  ...
  idSelectedProjectAstreint1 = "idSelectedProjectAstreint1";
  idSelectedTypeUpdateValue1 = "selectedTypeUpdateValue1";
  idSelectedUniteAstreint1 = "selectedUniteAstreint1";

  idSelectedProjectAstreint2 = "idSelectedProjectAstreint2";
  idSelectedTypeUpdateValue2 = "selectedTypeUpdateValue2";
  idSelectedUniteAstreint2 = "selectedUniteAstreint2";

  idSelectedProjectAstreint3 = "idSelectedProjectAstreint3";
  idSelectedTypeUpdateValue3 = "selectedTypeUpdateValue3";
  idSselectedUniteAstreint3 = "selectedUniteAstreint3";
  ...
  normalTypeActivity = new TypeActivity;
  panierRepasTypeActivity = new TypeActivity;

  ngOnInit(): void {


    this._TypeActivityService.findPanierRepas().subscribe(
      data => this.panierRepasTypeActivity = data,
    )

    this._TypeActivityService.findNormalActivity().subscribe(
      data => this.normalTypeActivity = data,
    )
    ...
    /** get all existing data of declaration */
    setTimeout(() => {
      this.historique();
    }, 60);
  ...
  /** found activity withc must be updated */
  ActivitiesToUpdate() {
    ...
    this._ActivityService.astreinteGroupByTypeActivity(this.monthSelected, this.yearInput, this.collaborateur.id).subscribe(
      ...
      data => {
        ...
        if (this.nbAstreinteWithId[1] !== undefined) {
          this._ActivityService.searchTheAstreinteOfCollaboratorOfProject(this.monthSelected, this.yearInput, this.collaborateur.id, this.nbAstreinteWithId[1], this.nbTypeAstreinteWithId[1]).subscribe(
            data => {
        ...
        if (this.nbAstreinteWithId[2] !== undefined) {
          this._ActivityService.searchTheAstreinteOfCollaboratorOfProject(this.monthSelected, this.yearInput, this.collaborateur.id, this.nbAstreinteWithId[2], this.nbTypeAstreinteWithId[2]).subscribe(
            data => {
  ...
  onChangeSelectprojectAstreinte1() {
    this._ProjectService.selectProjectById(this.selectedProjectAstreint1).subscribe(
      data => {
        this.theProjectAstreinte1 = data;
        return this.theProjectAstreinte1;
      },
      error => console.log("exception" + error)
    )
  }
  ...
  selectedTypeUpdate2() {
    this._TypeActivityService.selectTypeActivityById(this.selectedTypeUpdateValue2).subscribe(
      data => {
        this.theTypeActivity2 = data;
        return this.theTypeActivity2;
      },
      error => console.log("exception" + error)
    )
  }
  ...
  onChangeSelectprojectAstreinte2() {
    this._ProjectService.selectProjectById(this.selectedProjectAstreint2).subscribe(
      data => {
        this.theProjectAstreinte2 = data;
        return this.theProjectAstreinte2;
      },
      error => console.log("exception" + error)
    )
  }
  ...
  selectedTypeUpdate3() {
    this._TypeActivityService.selectTypeActivityById(this.selectedTypeUpdateValue3).subscribe(
      data => {
        this.theTypeActivity3 = data;
        return this.theTypeActivity3;
      },
      error => console.log("exception" + error)
    )
  }
  ...
  onChangeSelectprojectAstreinte3() {
    this._ProjectService.selectProjectById(this.selectedProjectAstreint3).subscribe(
      data => {
        this.theProjectAstreinte3 = data;
        return this.theProjectAstreinte3;
      },
      error => console.log("exception" + error)
    )
  }
  ...
  /** check if activity  1 to 4 exist */
  ...
  /** check if astreinte  1 to 3 exist */
  public isEmptyAstreinte1 = false;
  public isEmptyAstreinte2 = false;
  public isEmptyAstreinte3 = false;
  checkAstreinte1Empty() {
    this._ActivityService.checkAstreinteEmpty(this.monthSelected, this.yearInput, this.collaborateur.id, this.theProjectAstreinte1.id, this.theTypeActivity1.id).subscribe(
      data => {
        setTimeout(() => {
  ...
  checkAstreinte2Empty() {
    this._ActivityService.checkAstreinteEmpty(this.monthSelected, this.yearInput, this.collaborateur.id, this.theProjectAstreinte2.id, this.theTypeActivity2.id).subscribe(
      data => {
        setTimeout(() => {
  ...
  checkAstreinte3Empty() {
    this._ActivityService.checkAstreinteEmpty(this.monthSelected, this.yearInput, this.collaborateur.id, this.theProjectAstreinte3.id, this.theTypeActivity3.id).subscribe(
      data => {
        setTimeout(() => {
  ...
  async EnregisterEtEnvoyer() {
    ...
    /** searching activites to update  */
    this.ActivitiesToUpdate();

    /** check activity Empty */

    /** checking if activitys is empty */
    ...
    /** checking if astreinte is empty */
    if (this.theProjectAstreinte1.id != undefined) {
      this.checkAstreinte1Empty();
    }
    if (this.theProjectAstreinte2.id != undefined) {
      this.checkAstreinte2Empty();
    }
    if (this.theProjectAstreinte3.id != undefined) {
      this.checkAstreinte3Empty();
    }


    setTimeout(() => {

      /** ADDING AND UPDATING ACTIVITYS/ASTREINTE */
      setTimeout(() => {
        /** adding/update Activity 1 */
        for (var i = 0; i < this.tabJours.length; i++) {
      ...
      /** UPDATE ET AJOUT ASTREINTE 1 */
      setTimeout(() => {
        for (var i = 0; i < this.tabJours.length; i++) {
          if (this.isEmptyAstreinte1 === true) {
            if (this.totalAstreinte1 != 0) {
              ...
              if (this.selectedUniteAstreint1 == 1) {
                this.astreinte1.duration = +((<HTMLInputElement>document.getElementById(this.astreintePerDay1[i])).valueAsNumber / 24);
              } else {
            ...
            if (this.totalAstreinte1 != 0) {
              ...
              if (this.selectedUniteAstreint1 == 1) {
                this.newAstreinte1.duration = +((<HTMLInputElement>document.getElementById(this.astreintePerDay1[i])).valueAsNumber / 24);
              } else {
      ...
      /** UPDATE ET AJOUT ASTREINTE 2 */
      setTimeout(() => {
        for (var i = 0; i < this.tabJours.length; i++) {
          if (this.isEmptyAstreinte2 === true) {
            if (this.totalAstreinte2 != 0) {
              ...
              if (this.selectedUniteAstreint2 == 1) {
                this.astreinte2.duration = +((<HTMLInputElement>document.getElementById(this.astreintePerDay2[i])).valueAsNumber / 24);
              } else {
            ...
            if (this.totalAstreinte2 != 0) {
              ...
              this._ActivityService.addAndUpdateActivity(this.newAstreinte2, this.aujourdhui).subscribe(
                data => { console.log("astreinte 2 updated"); },
                error => {
                  console.log("erreur updated non-effectué")
                  this.message = "Enregistrement non effectué !";
                }
      ...
      /** UPDATE ET AJOUT ASTREINTE 3 */
      setTimeout(() => {
        for (var i = 0; i < this.tabJours.length; i++) {
          if (this.isEmptyAstreinte3 === true) {
            ...
            if (this.totalAstreinte3 != 0) {
              this.newAstreinte3.id = this.idOfDaysAstreinte2[i];
      ...
      /** ajout expense */
      this.checkExpenseEmpty();
      setTimeout(() => {

        if (this.expenseExist === false) {
          console.log("coucou")
  ...
  historique() {
    ...
    this.astreintePerDay1 = [];
    this.astreintePerDay2 = [];
    this.astreintePerDay3 = [];
        ...
        if (((this.monthSelected == (this.thisMonth - 1)) || (this.monthSelected == this.thisMonth)) && (this.yearInput == this.thisyear)) {
          ...
          this._ActivityService.activityGroupByProject(this.monthSelected, this.yearInput, this.collaborateur.id).subscribe(
            data => {
              ...
              for (var i = 0; i < this.tabJours.length - 1; i++) {
                ...
                (<HTMLInputElement>document.getElementById(this.totalAstreinte1HTML)).disabled = false;
                (<HTMLInputElement>document.getElementById(this.idRemplirProjetAstreinte1)).disabled = false;

                (<HTMLInputElement>document.getElementById(this.astreintePerDay2[i])).disabled = false;
                (<HTMLInputElement>document.getElementById(this.totalAstreinte2HTML)).disabled = false;
                (<HTMLInputElement>document.getElementById(this.idRemplirProjetAstreinte2)).disabled = false;

                (<HTMLInputElement>document.getElementById(this.astreintePerDay3[i])).disabled = false;
                (<HTMLInputElement>document.getElementById(this.totalAstreinte3HTML)).disabled = false;
                (<HTMLInputElement>document.getElementById(this.idRemplirProjetAstreinte3)).disabled = false;
          ...
          this._ActivityService.astreinteGroupByTypeActivityAndProjet(this.monthSelected, this.yearInput, this.collaborateur.id).subscribe(
            data => {
                  ...
                  data => {
                    ...
                    for (var i = 0; i < this.tabJours.length; i++) {
                      ...
                      this._TypeActivityService.selectTypeActivityById(this.astreinte1ToEdit[i].typeActivity.id).subscribe(
                        data => {
                          this.theTypeActivity1 = data;
                          this.selectedTypeUpdateValue1 = this.theTypeActivity1.id;
                        },
                        error => console.log("exception" + error)
                      )
                      this._ProjectService.selectProjectById(this.astreinte1ToEdit[i].projectId).subscribe(
                        data => {
                          this.theProjectAstreinte1 = data;
                          this.selectedProjectAstreint1 = this.theProjectAstreinte1.id;
                        },
                        error => console.log("exception" + error)
                      )
                      this.total5();
              ...
              /** astreinte 2 */
              if (this.nbTypeAstreinteWithId[1] !== undefined) {
                ...
                this._ActivityService.searchTheAstreinteOfCollaboratorOfProject(this.monthSelected, this.yearInput, this.collaborateur.id, this.nbAstreinteWithId[1], this.nbTypeAstreinteWithId[1]).subscribe(
                  data => {
                    ...
                    for (var i = 0; i < this.tabJours.length; i++) {
                      ...
                      this._TypeActivityService.selectTypeActivityById(this.astreinte2ToEdit[i].typeActivity.id).subscribe(
                        data => {
                          this.theTypeActivity2 = data;
                          this.selectedTypeUpdateValue2 = this.theTypeActivity2.id;
                        },
                        error => console.log("exception" + error)
                      )
                      this._ProjectService.selectProjectById(this.astreinte2ToEdit[i].projectId).subscribe(
                        data => {
                          this.theProjectAstreinte2 = data;
                          this.selectedProjectAstreint2 = this.theProjectAstreinte2.id;
                        },
                        error => console.log("exception" + error)
                      )
                      this.total6();
              ...
              /** astreinte 3 */
              if (this.nbTypeAstreinteWithId[2] !== undefined) {
                this._ActivityService.searchTheAstreinteOfCollaboratorOfProject(this.monthSelected, this.yearInput, this.collaborateur.id, this.nbAstreinteWithId[2], this.nbTypeAstreinteWithId[2]).subscribe(
                  data => {
                    this.astreinte3ToEdit = data;
                    for (var i = 0; i < this.tabJours.length; i++) {
                      (<HTMLInputElement>document.getElementById(this.astreintePerDay3[i])).valueAsNumber = this.astreinte3ToEdit[i].duration;
                      this._TypeActivityService.selectTypeActivityById(this.astreinte3ToEdit[i].typeActivity.id).subscribe(
                        data => {
                          this.theTypeActivity3 = data;
                          this.selectedTypeUpdateValue3 = this.theTypeActivity3.id;
                        },
                        error => console.log("exception" + error)
                      )
                      this._ProjectService.selectProjectById(this.astreinte3ToEdit[i].projectId).subscribe(
                        data => {
                          this.theProjectAstreinte3 = data;
                          this.selectedProjectAstreint3 = this.theProjectAstreinte3.id;
                        },
                        error => console.log("exception" + error)
                      )
                      this.total7();
          ...
          for (var i = 0; i <= this.tabJours.length - 1; i++) {
            ...
            (<HTMLInputElement>document.getElementById(this.idSelectedOption)).value = "";
            this.totalProjet1 = this.total();
            ...
            (<HTMLInputElement>document.getElementById(this.idSelectedOption2)).value = "";
            this.totalProjet2 = this.total2();
            ...
            (<HTMLInputElement>document.getElementById(this.idSelectedOption3)).value = "";
            this.totalProjet3 = this.total3();
            ...
            (<HTMLInputElement>document.getElementById(this.idSelectedOption4)).value = "";
            this.totalProjet3 = this.total4();

            (<HTMLInputElement>document.getElementById(this.astreintePerDay1[i])).disabled = true;
            (<HTMLInputElement>document.getElementById(this.totalAstreinte1HTML)).disabled = true;
            (<HTMLInputElement>document.getElementById(this.idRemplirProjetAstreinte1)).disabled = true;

            (<HTMLInputElement>document.getElementById(this.astreintePerDay2[i])).disabled = true;
            (<HTMLInputElement>document.getElementById(this.totalAstreinte2HTML)).disabled = true;
            (<HTMLInputElement>document.getElementById(this.idRemplirProjetAstreinte2)).disabled = true;

            (<HTMLInputElement>document.getElementById(this.astreintePerDay3[i])).disabled = true;
            (<HTMLInputElement>document.getElementById(this.totalAstreinte3HTML)).disabled = true;
            (<HTMLInputElement>document.getElementById(this.idRemplirProjetAstreinte3)).disabled = true;
  ...
  totalAllActivity() {
    this.totalActivity = +(this.totalProjet1 + this.totalProjet2 + this.totalProjet3 + this.totalProjet4).toFixed(2);;
    return this.totalActivity.toFixed(2);
  }
  totalProjet1 = 0;
  total() {
    this.totalProjet1 = 0;
  ...
  addExpense() {
    ...
    let jourFrais = new Date(this.yearInput, this.monthSelected - 1, 20)
    ...
    this.expense.dateExpense = jourFrais;
    this.expense.dateRequest = jourFrais;

    this._TypeExpenseService.selectTypeExpenseById(this.panierRepasTypeActivity.id).subscribe(
      data => {
  ...
  updateExpense(expense: Expense) {
    ...
    let jourFrais = new Date(this.yearInput, this.monthSelected, 1)
    ...
    this.newExpense.dateExpense = jourFrais;
    this.newExpense.dateRequest = jourFrais;
  ...
  imprimer() {
    ...
    var typeAstreinte1 = this.theTypeActivity1.type;
    var typeAstreinte2 = this.theTypeActivity2.type;
    var typeAstreinte3 = this.theTypeActivity3.type;


    tableOfindex2.push('Type')
    valueAstreinte1.push(typeAstreinte1 || "");
    valueAstreinte2.push(typeAstreinte2 || "");
    valueAstreinte3.push(typeAstreinte3 || "");


    tableOfindex2.push('Unité')
    valueAstreinte1.push("Jour");
    valueAstreinte2.push("Jour");
    valueAstreinte3.push("Jour");
    ...
    valueActivity1.push(totalActivity1.toFixed(2))
    valueActivity2.push(totalActivity2.toFixed(2))
    valueActivity3.push(totalActivity3.toFixed(2))
    valueActivity4.push(totalActivity4.toFixed(2))

    tableOfindex2.push('total')
    valueAstreinte1.push(totalAstreinte1.toFixed(2))
    valueAstreinte2.push(totalAstreinte2.toFixed(2))
    valueAstreinte3.push(totalAstreinte3.toFixed(2))
  ...
  Envoyer() {
    ...
    var astreinteProject1 = this.theProjectAstreinte1.projectTitle;
    var astreinteProject2 = this.theProjectAstreinte2.projectTitle;
    var astreinteProject3 = this.theProjectAstreinte3.projectTitle;

    var astreinteType1 = this.theTypeActivity1.type;
    var astreinteType2 = this.theTypeActivity2.type;
    var astreinteType3 = this.theTypeActivity3.type;
